...
> [!NOTE]
> The spatial reconstruction step at the end of the dense/segmentation forward pass has been corrected using `einops.rearrange` to faithfully map flattened patch embeddings back to their 2D positions.
